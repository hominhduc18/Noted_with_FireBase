...
public class CreateAccountActivity extends AppCompatActivity {
    ...
    void createAccount(){
        ...
        boolean validateDated = validateData(email, password,confirmPassword);
        if(!validateDated){
            return;
        }
        createAccounInFirebase(email, password);
    ...
    public void createAccounInFirebase(String email, String password){
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                           ...
                           Toast.makeText(CreateAccountActivity.this,"Successfully create account,Check email to verify",Toast.LENGTH_LONG).show();
                            firebaseAuth.getCurrentUser().sendEmailVerification();// gửi mã về email
